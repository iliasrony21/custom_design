  ...
  return (
   <section className="flex flex-col lg:flex-row items-center gap-12 md:gap-16 container mx-auto px-4 md:px-0 py-12 md:py-16 lg:py-20">
     ...
     <div className="flex justify-center lg:justify-start w-full lg:w-3/5">
      ...
      {/* Content Section */}
      <div className="lex flex-col justify-center space-y-4 md:space-y-6 w-full lg:w-3/5">
        <Link
          href="/"
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-5xl 2xl:text-5xl font-bold text-gray-900 leading-tight md:leading-snug max-w-120">
