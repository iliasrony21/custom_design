  ...
  return (
    <div className="py-10 ">
      ...
      <div className="w-full overflow-hidden">
        ...
        {/* Mobile & Laptop: h-96 (384px), Large screens: h-[500px] or h-[600px] */}
        <div className="hidden lg:grid grid-cols-[1fr_1fr_1fr_1.7fr_1fr_1fr_1fr] min-w-[1200px] w-full gap-[15px] h-96 xl:h-[350px] 2xl:h-[450px]">
          ...
          <div className="flex flex-col rounded-3xl my-10 overflow-hidden">
            <div className="w-full h-full relative">
              <Image src={two} alt="two" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[15px] overflow-hidden">
            ...
            <div className="flex-1 w-full relative rounded-3xl overflow-hidden">
              <Image src={three} alt="three" fill className="object-cover" />
            </div>
            {/* Bottom Card */}
            <div className="flex-1 w-full relative rounded-3xl overflow-hidden">
              <Image src={four} alt="four" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col overflow-hidden">
            <div className="w-full h-full relative rounded-3xl overflow-hidden">
              <Image src={five} alt="five" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[15px] overflow-hidden">
            {/* Top Card */}
            <div className="flex-1 w-full relative rounded-3xl overflow-hidden">
              <Image src={six} alt="six" fill className="object-cover" />
            </div>
            {/* Bottom Card */}
            <div className="flex-1 w-full relative rounded-3xl overflow-hidden">
              <Image src={seven} alt="seven" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col rounded-3xl my-10 overflow-hidden">
            <div className="w-full h-full relative">
              <Image src={eight} alt="eight" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col rounded-3xl my-25 overflow-hidden">
            <div className="w-full h-full relative">
              <Image src={nine} alt="nine" fill className="object-cover" />
            </div>
          </div>
        </div>
      ...
      <p className="text-center mx-auto my-14 text-2xl max-w-2xl font-semibold">
        Stand out from the crowd with custom T-shirts in a range of designs,
        colors and styles.
      </p>
    </div>
  );
