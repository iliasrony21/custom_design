...
const DesignCanvas = forwardRef(
  (
    ...
    const [canvasSize, setCanvasSize] = useState({ width: 300, height: 800 });
    ...
    return (
      <section className="flex-1 flex flex-col items-center justify-center relative">
        ...
        <div className="relative w-full h-[100vh] flex items-center justify-center">
          ...
          <div
            ref={canvasRef}
            className="absolute top-20 2xl:top-40 xl:top-23 md:top-20 lg:top-20 right-0 left-1/2 -translate-x-1/2 w-[50%] max-w-[400px] 2xl:max-w-[400px] xl:max-w-[280px] h-[50%] max-h-[380px] border-2 border-dashed border-gray-300 rounded-xl overflow-hidden bg-white/5"
            ...
            >
              ...
              {/* {currentUploadedArtTexts.map((text) => (
                <UploadedArtText
                  ...
                  onRemove={onRemoveArtText} // ✔ should work
                  onClick={onArtTextClick}
                  canvasRef={canvasRef}
                  canvasSize={canvasSize}
                  onDuplicate={onDuplicateArtText} // ✔ should work
                  getTextPath={getArtTextPath}
                />
              ))} */}
              {currentUploadedArtTexts.map((text) => (
                <UploadedArtText
